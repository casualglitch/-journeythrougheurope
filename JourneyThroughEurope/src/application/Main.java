...
public class Main extends Application {
    ...
    public enum JTEPropertyType {
        ...
        /* IMAGE FILE NAMES */
        WINDOW_ICON, SPLASH_SCREEN_IMAGE_NAME, SPLASH_GAME_IMAGE_NAME, BACK_IMG_NAME, UNDO_IMG_NAME, STATS_IMG_NAME, TIME_IMG_NAME, HOME_IMG_NAME, ABOUT_IMG_NAME, 
        ABOUTJTE_IMG_NAME, SAVE_IMG_NAME, FLIGHT_IMG_NAME, HISTORY_IMG_NAME, 
        TOP_LEFT_MAP_IMG_NAME, TOP_RIGHT_MAP_IMG_NAME, BOTTOM_LEFT_MAP_IMG_NAME, BOTTOM_RIGHT_MAP_IMG_NAME,
        TOP_LEFT_GRID_IMG_NAME, TOP_RIGHT_GRID_IMG_NAME, BOTTOM_LEFT_GRID_IMG_NAME, BOTTOM_RIGHT_GRID_IMG_NAME,
        CIRCLE_IMG_NAME,//HELP_IMG_NAME, EXIT_IMG_NAME, NEW_GAME_IMG_NAME, 
        /* DATA FILE STUFF */
        GAME_FILE_NAME, STATS_FILE_NAME, HELP_FILE_NAME, WORD_LIST_FILE_NAME, ABOUT_FILE_NAME, HISTORY_FILE_NAME, CITY_COORDS_FILE_NAME,
        /* TOOLTIPS */
